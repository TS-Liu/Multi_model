...
def make_features(batch, side, data_type='text'):
    ...
    Returns:
        ...
        of size (len x batch).
    """
    assert side in ['src', 'tgt', 'src_m', 'tgt_m', 'tgt_mp']
...
def build_dataset(fields, data_type, src_data_iter=None, src_path=None,
                  ...
                  srcm_data_iter=None, srcm_path=None,
                  tgtm_data_iter=None, tgtm_path=None,
                  tgt_mp_data_iter=None, tgt_mp_path=None,
...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    logger.info(" * tgt_m vocab size: %d." % len(fields["tgt_m"].vocab))
    ...
    if data_type == 'text':
        ...
        logger.info(" * src_m vocab size: %d." % len(fields["src_m"].vocab))
