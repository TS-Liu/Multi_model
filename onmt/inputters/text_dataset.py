...
class TextDataset(DatasetBase):
    ...
    def __init__(self, fields, src_examples_iter, tgt_examples_iter,
                 srcm_examples_iter, tgtm_examples_iter,
                 tgt_mp_examples_iter,
        ...
        if tgt_examples_iter is not None:
            if srcm_examples_iter is not None and tgtm_examples_iter is not None and tgt_mp_examples_iter is not None:
                examples_iter = (self._join_dicts(src, tgt, srcm, tgtm, tgt_mp) for src, tgt, srcm, tgtm, tgt_mp in
                             zip(src_examples_iter, tgt_examples_iter, srcm_examples_iter, tgtm_examples_iter, tgt_mp_examples_iter))
            else:
                examples_iter = (self._join_dicts(src, tgt) for src, tgt in
                                 zip(src_examples_iter, tgt_examples_iter))
        else:
            if srcm_examples_iter is not None and tgtm_examples_iter is not None and tgt_mp_examples_iter is not None:
                examples_iter = (self._join_dicts(src, srcm, tgtm, tgt_mp) for src, srcm, tgtm, tgt_mp in
                             zip(src_examples_iter, srcm_examples_iter, tgtm_examples_iter, tgt_mp_examples_iter))
            else:
